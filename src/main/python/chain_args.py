...
squishyd = '-ac_supply=1468750 -ac_eras=6 -ac_blocktime=420 -ac_end10000,100000,500000,1500000,2500000,5000000 -ac_sapling=1 -ac_cbmaturity=6 -ac_cc=0 -addnode=146.190.69.236 -addnode=143.198.59.2 -addressindex=1 -spentindex=1 -ac_staked=25 -ac_reward=10000000000,2500000000,1250000000,625000000,312500000,156250000'
getinfo = "getinfo"
